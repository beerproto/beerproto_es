 ...
 */
export declare class ConversionTimeUnit extends Message<ConversionTimeUnit> {
  /**
   * @generated from field: repeated beerproto.v1.ConversionTimeUnit.ConversionTimeUnitRate rates = 1;
   */
  rates: ConversionTimeUnit_ConversionTimeUnitRate[];

  constructor(data?: PartialMessage<ConversionTimeUnit>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "beerproto.v1.ConversionTimeUnit";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ConversionTimeUnit;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ConversionTimeUnit;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ConversionTimeUnit;

  static equals(a: ConversionTimeUnit | PlainMessage<ConversionTimeUnit> | undefined, b: ConversionTimeUnit | PlainMessage<ConversionTimeUnit> | undefined): boolean;
}

/**
 * @generated from message beerproto.v1.ConversionTimeUnit.ConversionTimeUnitRate
 */
export declare class ConversionTimeUnit_ConversionTimeUnitRate extends Message<ConversionTimeUnit_ConversionTimeUnitRate> {
  /**
   * @generated from field: beerproto.v1.TimeUnit target = 1;
   */
  target: TimeUnit;
  ...
  constructor(data?: PartialMessage<ConversionTimeUnit_ConversionTimeUnitRate>);

  static readonly runtime: typeof proto3;
  static readonly typeName = "beerproto.v1.ConversionTimeUnit.ConversionTimeUnitRate";
  static readonly fields: FieldList;

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): ConversionTimeUnit_ConversionTimeUnitRate;

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): ConversionTimeUnit_ConversionTimeUnitRate;

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): ConversionTimeUnit_ConversionTimeUnitRate;

  static equals(a: ConversionTimeUnit_ConversionTimeUnitRate | PlainMessage<ConversionTimeUnit_ConversionTimeUnitRate> | undefined, b: ConversionTimeUnit_ConversionTimeUnitRate | PlainMessage<ConversionTimeUnit_ConversionTimeUnitRate> | undefined): boolean;
}
 ...
 */
export declare const string_name: Extension<EnumValueOptions, string>;
 ...
 */
export declare const full_name: Extension<EnumValueOptions, string>;
